...
export default function AnalyticsHubPage() {
  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      if (cancelled) return
      if (!session) {
        router.replace('/analytics/login?redirect=/analytics')
        return
      }
      setAuthChecked(true)
      setLoading(false)
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <p className="mt-8 text-sm text-[var(--ice)]/60">

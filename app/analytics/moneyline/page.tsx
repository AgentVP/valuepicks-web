...
export default function MoneylineAnalyticsPage() {
  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      if (cancelled) return
      if (!session) {
        router.replace('/analytics/login?redirect=/analytics/moneyline')
        return
      }
      setAuthChecked(true)
    }
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <h1 className="text-2xl font-bold text-white mt-2">Moneyline</h1>
      <p className="text-[var(--ice)]/70 text-sm mt-1 mb-6">
        Moneyline analytics are coming soon.
      </p>
